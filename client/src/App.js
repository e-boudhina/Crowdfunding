...
<Route element={<CheckUserIsLoggedInAndVerified/>}>
            ...
            />
            <Route
              path={"/services/userRequests/view/:id"}
            ...
            <Route
              path={"/services/userRequests/add"}
              element={<AddUserRequest />}
            />
            <Route
              path={"/services/userRequests/user"}
              element={<ListUser_UserRequests />}
            />
            <Route
          ...
          <Route path={"/admin/tracking"} element={<Tracking />} />
            ...
            <Route
              path={"/admin/listcertificates"}
              element={<ListCertificates />}
            />
            <Route
              path={"/admin/ListProjectToValidate"}
              element={<ListProjectToValidate />}
            />
            ...
            <Route
              path={"/admin/user/update/:username"}
              element={<UpdateUser />}
            />
