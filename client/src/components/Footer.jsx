...
function Footer(){
    return (
        <footer data-background="../assets/img/bg/footer.jpg" style={{backgroundImage: 'url('+process.env.PUBLIC_URL+'/assets/img/bg/footer.jpg)'}}>
        {/* brand-area start */}
        <div className="brand-area pt-100 pb-80">
        ...
        {/* brand-area end */}
        <div className="footer-area pb-40">
          <div className="container">
            <div className="row">
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 d-lg-none d-xl-block">
                <div className="footer-widget mb-40">
