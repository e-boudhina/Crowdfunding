                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-xl-3 col-lg-4 d-none d-xl-block">
                    <div className="section-link mb-65 text-right">
                      <a className="btn-border btn-soft" href="#">more events</a>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-12">
                    <div className="basic-tab">
                      ...
                      <div className="tab-content" id="emyTabContent">
                        <div className="tab-pane fade" id="homee" role="tabpanel">
                        ...
                        <div className="tab-pane fade" id="profilee" role="tabpanel">
                          <div className="event-wrapper mb-40">
                            <div className="row">
                              <div className="col-lg-3 d-flex align-items-center">
                                <div className="event-time">
                        ...
                        <div className="tab-pane fade active show" id="contacte" role="tabpanel">
                          <div className="event-wrapper mb-40">
                            <div className="row">
                              <div className="col-lg-3 d-flex align-items-center">
                                <div className="event-time">
